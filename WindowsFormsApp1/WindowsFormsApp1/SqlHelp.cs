...
namespace WindowsFormsApp1
{
    internal class SqlHelp
    {
        ...
        private const string connectionString = "Data Source=172.23.29.89;Pooling=False;Max Pool Size = 1024;Initial Catalog=parking;Persist Security Info=True;User ID=sa;Password=123";
